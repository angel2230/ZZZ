...
void XGlueGame::CreateNewCharacter( const char* szName, MWLua::table t)
{
	...
	{
		TALENT_STYLE __STYLE[] = { TS_DEFENDER, TS_BERSERKER, TS_CLERIC, TS_SORCERER, TS_ASSASSIN };
		int temp = t.get<int>("style");

		TALENT_STYLE nStyle = __STYLE[temp-1];

		XCHARACTER_CREATEINFO ci;
		ci.nStyle = nStyle;//TALENT_STYLE( t.get<int>("style"));
